...
# 문제 발생 시 되돌리기 (undo migration 필요)
flyway undo
```
...
2. **되돌릴 수 있는 구조**: 모든 마이그레이션은 Undo 스크립트 포함
...
|--------|-------------------|-----------|----------|
| API Gateway | `/actuator/health` | `/actuator/health/readiness` | `/actuator/health/liveness` |
| Note Service | `/actuator/health` | `/actuator/health/readiness` | `/actuator/health/liveness` |
| Card Service | `/actuator/health` | `/actuator/health/readiness` | `/actuator/health/liveness` |
| AI Service | `/health` | `/health/ready` | `/health/live` |
